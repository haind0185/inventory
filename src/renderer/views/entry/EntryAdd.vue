        ...
        <form class="flex flex-col justify-between h-full gap-1 p-2" style="height: 40rem;" @submit.prevent="onSave()">
                ...
                <template v-for="(entry, index) in entries">
                    <div class="flex w-full gap-3 entry-item">
                        ...
                        <fieldset class="w-[7rem] form-input flex items-center">
                            <input type="number" class="w-[4rem] text-center form-control" v-model="entry.LargeUnitQty" min="0" v-select-on-focus>
            ...
            <div class="">
                ...
                <div class="flex justify-around w-full">
                    ...
                    <button type="submit" class="btn w-[6rem]" :disabled="entries.length <= 0" tabindex="-1">{{ $t("button.save") }}</button>
                </div>
            </div>
        </form>
    </Modal>
